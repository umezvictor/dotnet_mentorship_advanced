...
public sealed class ResponseMessage
{
    ...
    public const string CategoryAdded = "Category was added successfully";
    public const string CategoryUpdated = "Category was updated successfully";
    public const string CategoryDeleted = "Category was deleted successfully";
    public const string CategoryNotFound = "Category not found";


    public const string ProductAdded = "Product was added successfully";
    public const string ProductUpdated = "Product was updated successfully";
    public const string ProductDeleted = "Product was deleted successfully";
